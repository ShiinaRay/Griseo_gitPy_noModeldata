...
def cutimage(filepath):
    ...
    results1 = []
    results2 = []
    answer1 = [8, 6, 0, -1, -1, -1, 4, -1, 9, 0, 2, -1, 0, -1, 6, 6, -1, -1, 0, -1, 4, 1, -1, -1, 1, 1, 8, 2, -1, -1]
    answer2 = [0, 4, 7, 5, 9, 7, 9, -1, 9, 4, 5, -1, 2, 4, -1, -1, 1, 0, 1, -1]
    #修改 mylist值  来适应右边的表格
    # for n in range(-1, -6, -1):
    #     mylisty[n]=mylisty[n]-6
    mylisty[-1] = mylisty[-1] - 6
    mylisty[-2] = mylisty[-2] - 6
    mylisty[-3] = mylisty[-3] - 6
    mylisty[-4] = mylisty[-4] - 6
    ...
    mylisty[-1] = mylisty[-1] - 3
    mylisty[-2] = mylisty[-2] - 3
    mylisty[-3] = mylisty[-3] - 2
    mylisty[-4] = mylisty[-4] - 2
    mylisty[-5] = mylisty[-5] - 2
    mylistx[-10]=mylistx[-10]-2
    mylistx[-11]=mylistx[-11]-0
    mylistx[-12]=mylistx[-12]-7
    mylistx[-13]=mylistx[-13]-18
    # mylistx[-13]=mylistx[-13]-20
